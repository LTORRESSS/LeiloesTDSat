...
public class cadastroVIEW extends javax.swing.JFrame {
   ...
   String nome_produto = cadastroNome.getText();
    int valor_produto = Integer.parseInt(cadastroValor.getText());

    ProdutosDTO objproduto = new ProdutosDTO();
    objproduto.setNome(nome_produto);
    objproduto.setValor(valor_produto);
    objproduto.setStatus("Disponível"); // já cadastra com status fixo

    ProdutosDAO objprodutosdao = new ProdutosDAO();
    boolean sucesso = objprodutosdao.cadastrarProduto(objproduto);
